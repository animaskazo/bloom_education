...
const navItems = [
  ...
  { to: '/app/personal',       icon: Users,           label: 'Personal' },
  { to: '/app/estudiantes',    icon: GraduationCap,   label: 'Estudiantes' },
  { to: '/app/cursos',         icon: BookOpen,        label: 'Cursos' },
  { to: '/app/comunicados',    icon: MessageSquare,   label: 'Comunicación Interna' },
  { to: '/app/padres',         icon: Bell,            label: 'Comunicación Padres' },
  { to: '/app/pagos',          icon: CreditCard,      label: 'Pagos Apoderados' },
  { to: '/app/proveedores',    icon: Package,         label: 'Pagos Proveedores' },
]
      ...
      <div className="flex items-center gap-3 px-4 py-5 border-b border-slate-100">
        ...
        {!collapsed && (
          <div className="animate-slide-in overflow-hidden">
            <p className="font-display font-semibold text-slate-900 leading-none">EduTrack</p>
