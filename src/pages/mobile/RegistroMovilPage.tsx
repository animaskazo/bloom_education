      ...
      {mode === 'registry' && currentEst && (
        <div className="flex-1 flex flex-col h-full bg-slate-50">
          ...
          <div className="flex-1 overflow-y-auto px-4 py-5 space-y-5 flex flex-col items-center">
            ...
            {/* Header del Alumno */}
            <div className="w-full p-4 bg-white rounded-3xl shadow-sm border border-slate-100 flex flex-col items-center text-center relative ">
              <h2 className="text-xl sm:text-2xl font-black text-slate-800 leading-tight break-words max-w-full">
                {currentEst?.nombre || 'Sin Nombre'} {currentEst?.apellido || ''}
              </h2>
                    ...
                    {q.opciones.map((opt, i) => {
                      ...
                      return (
                        <button
                          ...
                          className={`py-3 px-2 rounded-xl text-xs font-bold transition-all active:scale-95 border-2 ${isSelected
